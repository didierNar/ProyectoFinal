...
INSERT INTO `Egresados`.`T_EMPRESA` (`NIT`, `direccion`, `razon_social`, `telefono`, `tipo_empresa`, `dir_web`, `ID_CIUDAD`, `depto`, `pais`, `ID_SECTOR`) VALUES ('654', 'boreal', 'no se', '300712', 'PRIVADA', 'boreal.com', 543, 432, 321, 2);