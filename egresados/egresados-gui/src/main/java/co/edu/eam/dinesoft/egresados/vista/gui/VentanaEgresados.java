...
public class VentanaEgresados extends javax.swing.JFrame implements ActionListener {
	...
	private void initComponents() {
		...
		jCBOfertas = new javax.swing.JComboBox();
								...
								.addGroup(
										jPInfoAcademicaLayout.createSequentialGroup().addGap(23, 23, 23)
												...
												.addGroup(jPInfoAcademicaLayout
														.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING,
																false)
														.addComponent(jLabel20).addComponent(jLabel12)
														.addComponent(jTFNumeroDiploma,
														...
														.addGroup(jPInfoAcademicaLayout
																...
																.addComponent(jCBPrograma, 0, 200, Short.MAX_VALUE))
														.addComponent(jCBOfertas, 0,
																javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
												.addContainerGap(77, Short.MAX_VALUE)));
		jPInfoAcademicaLayout.setVerticalGroup(jPInfoAcademicaLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPInfoAcademicaLayout.createSequentialGroup().addGap(42, 42, 42)
						...
						.addGroup(jPInfoAcademicaLayout
								...
								.addGroup(jPInfoAcademicaLayout.createSequentialGroup().addComponent(jLabel10)
										.addGap(18, 18, 18).addComponent(jDFechaGrado,
												javax.swing.GroupLayout.PREFERRED_SIZE,
						...
						.addGroup(jPInfoAcademicaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(jPInfoAcademicaLayout.createSequentialGroup().addGap(18, 18, 18)
										.addComponent(jCBOfertas, javax.swing.GroupLayout.DEFAULT_SIZE, 37,
												Short.MAX_VALUE)
										.addGap(101, 101, 101))
								.addGroup(jPInfoAcademicaLayout.createSequentialGroup().addGap(42, 42, 42)
		...
		jPInfoLaboralLayout
				.setHorizontalGroup(
						jPInfoLaboralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(jPInfoLaboralLayout
										.createSequentialGroup().addGap(26, 26, 26).addGroup(jPInfoLaboralLayout
												...
												.addComponent(jLabel16).addComponent(jCBEmpresaEgre,
				...
				.addGroup(jPInfoLaboralLayout.createSequentialGroup().addGap(37, 37, 37)
						...
						.addGroup(jPInfoLaboralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								...
								.addComponent(jCBSectorLab, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(13, 13, 13).addComponent(jLabel16).addGap(18, 18, 18)
	...
	private javax.swing.JComboBox jCBOfertas;
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (arg0.getSource() == jBBuscar) {
			...
			try {
				...
				jCBOfertas.setSelectedItem(info.getOfertaLaboral());
		...
		if (arg0.getSource() == jBEditar) {
			...
			try {
				...
				if (egresadoEncontrado == null) {
					...
					OfertaLaboral areasOferta = (OfertaLaboral)jCBOfertas.getSelectedItem();
		...
		if (arg0.getSource() == jBRegistro) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "La informacion se ha agregado satisfactoriamente");
	...
	private void refrescarComboOfertas() {
		try {
			List<OfertaLaboral> lista = controlador.listaOfertas();
			jCBOfertas.removeAllItems();
			for (OfertaLaboral ofertaLaboral : lista) {
				jCBOfertas.addItem(ofertaLaboral);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
