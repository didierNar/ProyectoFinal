...
public class VentanaEmpresa extends javax.swing.JFrame implements ActionListener {
    ...
    private void initComponents() {
        ...
        jCBTipoEmp = new javax.swing.JComboBox<String>();
        ...
        jCBTipoEmp.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Seleccione Opción", "Privada", "Pública" }));
        ...
        jPDatosEmpresaLayout.setHorizontalGroup(
            ...
            .addGroup(jPDatosEmpresaLayout.createSequentialGroup()
                ...
                .addGroup(jPDatosEmpresaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jCBTipoEmp, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private javax.swing.JComboBox<String> jCBTipoEmp;
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (arg0.getSource() == jBEditar) {
			try {
				if (empresaBuscada == null) {
					...
					TipoEmpresa tipo = (TipoEmpresa) jCBTipoEmp.getSelectedItem();
		...
		if (arg0.getSource() == jBBuscar) {
			...
			try {
				...
				int nit = Integer.parseInt(JOptionPane.showInputDialog(null, "Ingrese el NIT de la empresa"));
				...
				jCBTipoEmp.setSelectedItem(emp.getTipo());
	...
	private void limpiarCampos() {
		...
		jTFTel.setText(null);
		jCBTipoEmp.setSelectedItem(null);
